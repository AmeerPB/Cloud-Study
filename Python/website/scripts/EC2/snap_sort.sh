...
# Get a list of all EC2 snapshots owned by your account in the us-east-1 region
snapshots=$(aws ec2 describe-snapshots --owner-ids self --region us-east-1 --query 'Snapshots[*].[SnapshotId,StartTime]' --output text)
